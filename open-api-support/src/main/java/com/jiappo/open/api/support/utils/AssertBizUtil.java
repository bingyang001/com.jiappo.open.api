package com.jiappo.open.api.support.utils;
 ...
 */
public class AssertBizUtil {
    private static final Logger LOGGER = LoggerFactory.getLogger(AssertBizUtil.class);

    private AssertBizUtil() {
